...
{
    public partial class frmEditHHNhap : Form
    {
        public frmEditHHNhap(string maHang, string tenHang, string dvt, string donGia)
        {
            InitializeComponent();
        ...
        private void frmEditHHNhap_Load(object sender, EventArgs e)
        {
        ...
        private void LoadMaHangToComboBox()
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    string query = "SELECT DVT FROM HangHoaNhap";
        ...
        private void bnCancel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                txtDGN.Text = string.Empty; // Giả sử bạn có TextBox tên là txtSoLuong
        ...
        private void bnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string giaNhap = txtDGN.Text.Trim(); // Lấy giá trị Giá Nhập từ TextBox
                ...
                // Câu lệnh SQL UPDATE để cập nhật dữ liệu trong bảng HangHoaNhap
                string query = "UPDATE HangHoaNhap SET TenHang = @TenHang, DVT = @DVT, DonGiaNhap = @DonGiaNhap WHERE MaHang = @MaHang";
